...
<li><a href="/terms-of-service">Terms of Service</a></li>
    ...
    const settings = [
      ...
      // About Page
      { key: 'about_title', value: 'About Wissen-Haus' },
      { key: 'about_subtitle', value: 'Empowering young people to reach their full potential and create positive change' },
      { key: 'about_org_description', value: 'Wissen-Haus Empowerment Foundation is a youth-focused, non-profit organization committed to empowering young people to reach their full potential. We exist to inspire growth, build capacity, and create pathways that help young individuals develop the confidence, skills, and mindset needed to navigate life.' },
      { key: 'about_org_description2', value: 'Founded on the belief that every young person has unlimited potential, we work tirelessly to unlock that potential through mentorship, skills development, and community support.' },
      { key: 'about_approach1', value: 'We provide access to quality education and learning resources tailored to individual needs and aspirations.' },
      { key: 'about_approach2', value: 'Through hands-on training and practical experience, we help young people develop in-demand skills.' },
      { key: 'about_approach3', value: 'Our experienced mentors provide guidance, inspiration, and personalized support throughout their journey.' },
      { key: 'about_impact1_value', value: '10,000+' },
      { key: 'about_impact1_label', value: 'Young People Reached' },
      { key: 'about_impact2_value', value: '500+' },
      { key: 'about_impact2_label', value: 'Mentors & Volunteers' },
      { key: 'about_impact3_value', value: '50+' },
      { key: 'about_impact3_label', value: 'Skills Programs' },
      { key: 'about_impact4_value', value: '$2.5M+' },
      { key: 'about_impact4_label', value: 'Impact Generated' },
      { key: 'about_value1', value: 'We believe every individual has the potential to grow and achieve their goals with proper support, mentorship, and opportunities.' },
      { key: 'about_value2', value: 'We are committed to breaking barriers and ensuring all young people, regardless of background, have equal access to quality education and opportunities.' },
      { key: 'about_value3', value: 'We foster a culture of mutual support, collaboration, and shared responsibility for uplifting one another and our communities.' },
      { key: 'about_value4', value: 'We strive for excellence in everything we do, delivering high-quality programs and support that create lasting positive change.' },
      { key: 'about_cta_title', value: 'Join Our Mission' },
      { key: 'about_cta_description', value: 'Help us transform lives and create lasting change in communities. Whether through donations, volunteering, or partnership, your support makes a real difference.' },

      // Contact Page
      { key: 'contact_title', value: 'Get In Touch' },
      { key: 'contact_subtitle', value: 'Have questions or want to collaborate? We\'d love to hear from you.' },
      { key: 'contact_address', value: '123 Impact Street, Berlin, Germany 10115' },
      { key: 'contact_hours', value: 'Monday - Friday\n9:00 AM - 6:00 PM CET' },
      { key: 'contact_response_info', value: 'We typically respond to all inquiries within 24-48 business hours. For urgent matters, please call us directly at the number above.' },

      // FAQ Page
      { key: 'faq_title', value: 'Frequently Asked Questions' },
      { key: 'faq_subtitle', value: 'Find answers to common questions about Wissen-Haus and our programs' },
      { key: 'faq_support_title', value: 'Still have questions?' },
      { key: 'faq_support_description', value: 'We\'re here to help! Reach out to our support team and we\'ll get back to you as soon as possible.' },
      { key: 'faq1_question', value: 'What is Wissen-Haus?' },
      { key: 'faq1_answer', value: 'Wissen-Haus is a youth-focused non-profit organization dedicated to empowering young people through knowledge transfer, skills development, and mentorship programs.' },
      { key: 'faq2_question', value: 'Who can benefit from your programs?' },
      { key: 'faq2_answer', value: 'Our programs are designed for young people of all backgrounds aged 13-30. We welcome anyone passionate about personal growth and making a difference in their community.' },
      { key: 'faq3_question', value: 'How much does it cost to participate?' },
      { key: 'faq3_answer', value: 'Most of our programs are free or low-cost. We believe quality education and development should be accessible to everyone regardless of financial status.' },
      { key: 'faq4_question', value: 'How can I donate?' },
      { key: 'faq4_answer', value: 'You can make a secure donation through our website using your credit card or bank transfer. All donations are tax-deductible and directly support our programs.' },
      { key: 'faq5_question', value: 'Can I volunteer with Wissen-Haus?' },
      { key: 'faq5_answer', value: 'Absolutely! We\'re always looking for passionate volunteers and mentors. Please contact us to learn about opportunities.' },
      { key: 'faq6_question', value: 'What programs do you offer?' },
      { key: 'faq6_answer', value: 'We offer skills development workshops, leadership training, mentorship programs, career counseling, and personal development coaching tailored to individual goals.' },
      { key: 'faq7_question', value: 'How are donations used?' },
      { key: 'faq7_answer', value: 'Donations directly support program delivery, mentor training, educational materials, and scholarships. We maintain transparent financial practices and publish annual reports.' },
      { key: 'faq8_question', value: 'Is my donation secure?' },
      { key: 'faq8_answer', value: 'Yes! We use Stripe to securely process payments. We never store credit card information and maintain industry-standard security practices.' },

      // Blog Page
      { key: 'blog_title', value: 'Our Blog' },
      { key: 'blog_subtitle', value: 'Stories, insights, and updates from Wissen-Haus' },
      { key: 'blog_newsletter_text', value: 'Subscribe to our newsletter to get the latest stories and updates from Wissen-Haus.' },

      // Donate Page
      { key: 'donate_title', value: 'Make a Donation' },
      { key: 'donate_subtitle', value: 'Your generosity fuels our mission to empower young people to reach their full potential.' },
      { key: 'donate_impact1', value: 'Mentorship Sessions' },
      { key: 'donate_impact1_desc', value: 'Provides mentorship sessions for one young person' },
      { key: 'donate_impact2', value: 'Skills Workshop' },
      { key: 'donate_impact2_desc', value: 'Covers skills workshop materials for 10 participants' },
      { key: 'donate_impact3', value: 'Leadership Program' },
      { key: 'donate_impact3_desc', value: 'Funds comprehensive leadership program for a cohort' },
      { key: 'donate_impact4', value: 'Full Scholarship' },
      { key: 'donate_impact4_desc', value: 'Enables a full scholarship for an exceptional youth' },
      { key: 'donate_why', value: '100% of your donation supports our programs and initiatives. Our organization is run by passionate volunteers committed to making a real difference in young people\'s lives. Every contribution directly enables educational programs, mentorship, skills development, and life-changing opportunities.' },
      { key: 'donate_faq1', value: 'Yes, we use Stripe to securely process all payments. Your financial information is never stored on our servers.' },
      { key: 'donate_faq2', value: 'Yes, you\'ll receive a donation receipt via email immediately after your contribution.' },
      { key: 'donate_faq3', value: 'Yes, monthly donations are available. Select the recurring option during checkout.' },
